...
const String resumeUrl = 'https://drive.google.com/file/d/16cB9zkSuyHyY-QqIW_5YevFWK2o0WmSd/view?usp=sharing';
...
final size11weight900 = appFontTextStyle.copyWith(fontSize: 11.0, fontWeight: FontWeight.w900, color: textColor);
...
final size12weight900 = appFontTextStyle.copyWith(fontSize: 12.0, fontWeight: FontWeight.w900, color: textColor);
...
final size13weight900 = appFontTextStyle.copyWith(fontSize: 13.0, fontWeight: FontWeight.w900, color: textColor);
...
final size14weight900 = appFontTextStyle.copyWith(fontSize: 14.0, fontWeight: FontWeight.w900, color: textColor);
...
final size15weight900 = appFontTextStyle.copyWith(fontSize: 15.0, fontWeight: FontWeight.w900, color: textColor);
...
final size16weight900 = appFontTextStyle.copyWith(fontSize: 16.0, fontWeight: FontWeight.w900, color: textColor);
...
final size17weight900 = appFontTextStyle.copyWith(fontSize: 17.0, fontWeight: FontWeight.w900, color: textColor);
...
final size18weight900 = appFontTextStyle.copyWith(fontSize: 18.0, fontWeight: FontWeight.w900, color: textColor);
...
final size20weight900 = appFontTextStyle.copyWith(fontSize: 20.0, fontWeight: FontWeight.w900, color: textColor);
...
final size24weight900 = appFontTextStyle.copyWith(fontSize: 24.0, fontWeight: FontWeight.w900, color: textColor);
...
final size32weight900 = appFontTextStyle.copyWith(fontSize: 32.0, fontWeight: FontWeight.w900, color: textColor);
