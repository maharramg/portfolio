...
const jobs = [
  JobModel(
    ...
    description: '• Developed "Tendo by Tonik" - an innovative installment solution for online shopping in the Philippines that provides a flexible and convenient way for managing payments for online purchases\n• Spearheaded end-to-end development and collaborated with cross-functional teams\n• Successfully integrated third-party APIs to enhance the app\'s functionality and expand the user base',
  ),
  JobModel(
    companyName: 'Tentony',
